...
<!--
                <input type="radio" name="type" value="2" onclick="typechosen()"> 供货商
                <input type="radio" name="type" value="3" onclick="typechosen()"> 路线管理员
-->
                <input type="radio" name="type" value="4" onclick="typechosen()"> 送货员
<!--                <input type="radio" name="type" value="5" onclick="typechosen()"> 库存管理员 -->
