...
//      window.parent.location.href = '<?php echo $rs['redirect']; ?>';
  }
}
</script>
</head>
...
<div class="wrap">
  <div class="banner fl">
    <h1><a href="http://www.vanfruits.ca/">VANFRUITS.COM</a></h1>
    <h2 class="mt10">温鲜生B2C电子商务平台</h2>
    <p class="mt8">Vanfruits B2C Platform</p>
  </div>
    <div class="login">
      <h2 class="c666">系统提示</h2>
          <br />
